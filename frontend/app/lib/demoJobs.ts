...
const demoJobs: CreateJobInput[] = [
  ...
  { company: 'Figma', role: 'Design Engineer', status: 'Wishlist', location: 'San Francisco, CA', salary: '$150k - $200k', notes: 'Dream job - waiting for right opportunity' },
  ...
  { company: 'Anthropic', role: 'Software Engineer', status: 'Wishlist', location: 'San Francisco, CA', salary: '$180k - $300k', jobUrl: 'https://anthropic.com/careers', notes: 'Amazing company, planning to apply soon' },
];
